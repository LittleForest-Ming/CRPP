...
class Config:
    def __init__(self):
        ...
        self._configs["cache_dir"] = "./result"

        self._configs["config_dir"] = "./configs"
        self._configs["result_dir"] = "./detect"
    ...
    def snapshot_dir(self):
        snapshot_dir = os.path.join(self.cache_dir, "result", self.snapshot_name)
    ...
    def box_snapshot_dir(self):
        box_snaptshot_dir = os.path.join(self.box_cache_dir, 'result', self.snapshot_name)
