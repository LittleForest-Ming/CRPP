...
def parse_args():
    parser = argparse.ArgumentParser(description="Tool to generate qualitative detect videos")
    parser.add_argument("--pred", help=".pkl file to load predictions from")
    parser.add_argument("--cfg", default="configs.yaml", help="Config file")
    parser.add_argument("--cover", default="cover.png", help="Cover image file")
