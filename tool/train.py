...
from models.nnet import NetworkFactory
from torch.multiprocessing import Process, Queue, Pool
from factory.datasets import datasets
import models.utils.misc as utils
...
def parse_args():
    ...
    parser.add_argument("--cfg_file", help="configs file", default='train', type=str)
...
def train(training_dbs, validation_db, start_iter=0, freeze=False):
    ...
    data_file   = "custo.{}".format(training_dbs[0].data) # "custo.coco"
...
if __name__ == "__main__":
    ...
    training_dbs  = [datasets[dataset](configs["factory"], train_split) for _ in range(threads)]
    validation_db = datasets[dataset](configs["factory"], val_split)

    # print("system configs...")
    # pprint.pprint(system_configs.full)
    #
    # print("factory configs...")
    # pprint.pprint(training_dbs[0].configs)

    print("len of training factory: {}".format(len(training_dbs[0].db_inds)))
    print("len of testing factory: {}".format(len(validation_db.db_inds)))
